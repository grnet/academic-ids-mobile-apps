...
#import "AcademicID_CheckView3Controller.h"
#import "AcademicID_CheckAppDelegate.h"
#import "AcademicID_CheckViewController.h"
#import <YAJLiOS/YAJL.h>
#import "NSData+Base64.h"
#import <CommonCrypto/CommonDigest.h>


@implementation AcademicID_CheckView3Controller
...
-(IBAction)savePWD:(id)sender
{
	...
	else if (![[AcademicID_CheckViewController md5:[[NSString alloc] initWithFormat:@"%@", [existingPWD text]]] isEqualToString:[appDelegate pwdMD5Stored]])
	{
	...
	else 
	{
		...
		NSString *newPwdMD5String = [AcademicID_CheckViewController md5:[[NSString alloc] initWithFormat:@"%@", [theNewPWD text]]];
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection {
	...
	if ([[responseDictionary objectForKey:@"response"] isEqualToString:@"SUCCESS"])
	{
		...
		[appDelegate setPwdMD5Stored:[AcademicID_CheckViewController md5:[[NSString alloc] initWithFormat:@"%@", [theNewPWD text]]]];
