//
//  AcademicID_CheckViewController.m
...
@implementation AcademicID_CheckViewController
...
-(IBAction)login:(id)sender
{
	if ([[usernameField text] length] == 0) {
		UIAlertView* alertView = [[UIAlertView alloc] initWithTitle:@"Προσοχή"
															message:@"Δεν έχετε εισάγει Όνομα Χρήστη" delegate:nil 
